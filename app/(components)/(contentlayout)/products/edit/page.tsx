...
const EditProduct = () => {
    ...
    const fetchProductData = async () => {
        try {
            ...
            // Convert dates in discounts
            if (productData.pricing?.discounts) {
                productData.pricing.discounts = productData.pricing.discounts.map((discount: any) => ({
                    ...discount,
    ...
    return (
        <Fragment>
            ...
            <Pageheader currentpage="Edit Product" activepage="Products" mainpage="Edit Product" />
