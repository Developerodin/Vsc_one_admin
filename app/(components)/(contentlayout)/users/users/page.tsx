...
const Users = () => {
  ...
  return (
    <Fragment>
      ...
      {/* Update User Modal */}
      <div id="update-user" className={`hs-overlay ${showUpdateModal ? '' : 'hidden'} ti-modal`}>
        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
          <div className="ti-modal-content">
            <div className="ti-modal-header">
              <h6 className="modal-title" id="staticBackdropLabel2">
            ...
            <form onSubmit={handleUpdateSubmit}>
              <div className="ti-modal-body">
                <div className="grid grid-cols-12 gap-2">
                  ...
                  <div className="xl:col-span-6 col-span-12">
                    <label htmlFor="update-kycStatus" className="form-label">
                      KYC Status
                    </label>
                    <Select
                      id="update-kycStatus"
                      options={KycStatusOptions}
                      value={KycStatusOptions.find(option => option.value === updateFormData.kycStatus)}
