                                            ...
                                            <div className="ti-modal-body">
                                                <div className="grid grid-cols-12 gap-2">
                                                    <div className="xl:col-span-6 col-span-12">
                                                        ...
                                                        <input type="text" className="form-control" id="category-name" placeholder="Enter Category Name" />
                                                    </div>
                                                    <div className="xl:col-span-6 col-span-12">
                                                        <label htmlFor="subcategory-count" className="form-label">Subcategories</label>
                                                        <input type="number" className="form-control" id="subcategory-count" placeholder="Enter number of subcategories" />
                                                    </div>
                                                    <div className="xl:col-span-6 col-span-12">
